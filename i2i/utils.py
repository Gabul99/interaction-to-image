...
from i2i.pipeline import PixArtAlphaPipeline
from i2i.transformer_2d import Transformer2DModel
from i2i.scheduler import I2IDPMSolverMultistepScheduler
...
def load_i2i_model(model_id, device):
    """
    Loads the GroundIt model pipeline with specified configurations.
    ...
    pipe.scheduler = I2IDPMSolverMultistepScheduler.from_config(pipe.scheduler.config)
